#final assigment on adobe dataset
import numpy as np
import pandas as pd
...
df=pd.read_csv(r"C:\Users\Laptop Solutions\Documents\Full-Stack-AI-Bootcamp-B-11\FinalAssessment\Adobe(ADBE)Stock\Adobe (ADBE) From 1986 To Dec-2024.csv")
print(df.head(5))
print(df.info())
